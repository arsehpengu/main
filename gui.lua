...
-- Window
local Window, MainGUI = Library:CreateWindow("feat.")

-- Tabs
local Tab1 = Window:CreateTab("Aim")
local Tab2 = Window:CreateTab("Coming  soon")
...
-- Groupbox 1
local ExampleToggle = Groupbox1:CreateToggle("Headless", function(state)
   loadstring(game:HttpGet("https://raw.githubusercontent.com/arsehpengu/main/main/headlesscript.lua"))()
end)

local ExampleToggle2 = Groupbox1:CreateToggle("Korblox", function(state)
   loadstring(game:HttpGet("https://raw.githubusercontent.com/arsehpengu/main/main/korbloxscript.lua"))()
end)
